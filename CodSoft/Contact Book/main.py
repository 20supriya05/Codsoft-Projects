...
class ContactBookApp:
    def __init__(self, root):
        ...
        # Buttons
        self.add_button = tk.Button(root, text="Add Contact", font=self.button_font, command=self.add_contact, bg="#4CAF50", fg="white", relief=tk.RAISED)
        ...
        self.search_entry = tk.Entry(root, width=20, font=self.entry_font)
        self.search_entry.grid(row=3, column=1, padx=10, pady=5, sticky=tk.W)

        self.search_button = tk.Button(root, text="Search", font=self.button_font, command=self.search_contact, bg="#2196F3", fg="white", relief=tk.RAISED)
        ...
        self.update_button = tk.Button(root, text="Update Contact", font=self.button_font, command=self.update_contact, bg="#FFEB3B", fg="black", relief=tk.RAISED)
